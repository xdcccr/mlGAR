...
summ_rownames = c("IIV",
                  ...
                  "Level2Var_theta1","Level2Var_theta2","Level2Var_theta3","Level2Cov_14")
# 
...
R = 1 # measurement error variance #no not measurement error, should call it process noise
...
# PART 2. Specifying Level-2 model # should match data generation
  ...
  Theta1AndAR[id,1:2]~dmnorm(c(Level2Mean_theta1,Level2MeanAR), Level2Prec14)
  MU_thetas[id,1] = Theta1AndAR[id,1]
  AR[id] = Theta1AndAR[id,2]
...
# PART 3. Specifying prior distributions 
  ...
  # MU
    ...
    Level2Cor_14 ~ dunif(0.01,1)
    Level2Var_theta1 = pow(Level2Sd_theta1,2)
    Level2Var_theta2 = pow(Level2Sd_theta2,2)
    Level2Var_theta3 = pow(Level2Sd_theta3,2)
    Level2Cov_14 = Level2Sd_theta1*Level2Cor_14*Level2Sd_AR
    
    Level2Cov14[1,1] <- Level2Var_theta1
    Level2Cov14[1,2] <- Level2Cov_14
    Level2Cov14[2,1] <- Level2Cov_14
    Level2Cov14[2,2] <- Level2Var_AR 
    Level2Prec14[1:2,1:2] <- inverse(Level2Cov14[1:2,1:2])
