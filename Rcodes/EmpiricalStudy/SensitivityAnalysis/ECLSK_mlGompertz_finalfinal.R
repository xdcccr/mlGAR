...
# Get the deviance
model_deviance <- -2 * logLik(read_sigmoid.nlme)
# Or directly
model_deviance <- deviance(read_sigmoid.nlme)

# Get the BIC
model_BIC <- BIC(read_sigmoid.nlme)

cat("Model deviance:", model_deviance, "\n")
cat("Model BIC:", model_BIC, "\n")
