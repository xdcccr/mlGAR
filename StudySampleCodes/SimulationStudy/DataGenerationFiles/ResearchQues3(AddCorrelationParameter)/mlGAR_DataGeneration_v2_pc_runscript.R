...
# 模板文件路径
template_path <- "D:/XXYDATAanalysis/IP_1/ClusterFile_PC/code/mlGAR_DataGeneration_v2_pc_template.R"

# 输出目录
output_dir <- "D:/XXYDATAanalysis/IP_1/ClusterFile_PC/code"
...
create_and_run_script <- function(params_temp) {#id=1
  ...
  # 定制文件名
  script_name <- paste0("mlGAR_v2_nP", nP, "nT", nT,".R")
