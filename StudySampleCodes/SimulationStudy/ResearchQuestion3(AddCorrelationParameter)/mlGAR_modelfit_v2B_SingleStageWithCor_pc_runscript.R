...
# 模板文件路径
template_path <- "D:/XXYDATAanalysis/IP_1/ClusterFile_PC/code/mlGAR_modelfit_v2B_SingleStageWithCor_pc_template.R"
...
create_and_run_script <- function(params_temp) {#id=1
  ...
  # 定制文件名
  script_name <- paste0("mlGAR_v2B_SingleStageWithCor_nP", nP, "nT", nT,"r",r,".R")
